                ...
                <ul class="navbar-nav items">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link" href="home-1.html#">One-Page <i class="icon-arrow-right"></i></a>
                                <ul class="dropdown-menu">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="nav-item dropdown">
                                <a class="nav-link" href="home-1.html#">About <i class="icon-arrow-right"></i></a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item"><a href="<?php echo base_url('about'); ?>" class="nav-link">About <span>1</span></a></li>
                                </ul>
                            </li>
                            <li class="nav-item"><a href="<?php echo base_url('service'); ?>" class="nav-link">Services</a></li>
                            <li class="nav-item dropdown">
                                <a class="nav-link" href="home-1.html#">Single Service <i class="icon-arrow-right"></i></a>
                                <ul class="dropdown-menu">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link" href="home-1.html#">Contact <i class="icon-arrow-right"></i></a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item"><a href="<?php echo base_url('contact'); ?>" class="nav-link">Contact <span>1</span></a></li>
                                </ul>
                            </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="nav-item dropdown">
                                <a class="nav-link" href="home-1.html#">Blog Posts <i class="icon-arrow-right"></i></a>
                                <ul class="dropdown-menu">
