...
?> 
            ...
            <div class="swiper-container full-slider animation slider-h-100 slider-h-auto">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide slide-center">
                        ...
                        <!-- Media -->
                        <img src="modules/assets/images/bg-1.jpg" alt="Full Image" class="full-image" data-mask="40">
                                ...
                                <div class="left text-left">
                                    ...
                                    <div data-aos="fade-up" data-aos-delay="2800" class="buttons">
                                        <div class="d-sm-inline-flex">
                                            <a href="home-1.html#contact" class="smooth-anchor mt-4 btn primary-button">GET IN TOUCH</a>
                                            <a href="home-1.html#video" class="smooth-anchor ml-sm-4 mt-4 btn outline-button">READ MORE</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide slide-center">
                        ...
                        <!-- Media -->
                        <img src="modules/assets/images/bg-2.jpg" alt="Full Image" class="full-image" data-mask="40">  
                    ...
                    <div class="swiper-slide slide-center">
                        ...
                        <!-- Media -->
                        <img src="modules/assets/images/bg-3.jpg" alt="Full Image" class="full-image" data-mask="40">     
                ...
                <div class="row text-center">
                    <div class="col-12 gallery">
                        <a href="https://vimeo.com/222990241" class="square-image d-flex justify-content-center align-items-center">
                            ...
                            <img src="modules/assets/images/video-1.jpg" class="fit-image" alt="Introduction Video">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <section id="funfacts" class="section-2 odd counter funfacts">
            <video class="full-image to-bottom grayscale" data-mask="70" playsinline autoplay muted loop>
                <source src="modules/assets/videos/city.mp4" type="video/mp4" />
            </video>
            <div class="container">
            ...
            <div class="container">
                <div class="row intro">
                    ...
                    <div class="col-12 col-md-3 align-self-end">
                        <a href="home-1.html#" class="btn mx-auto mr-md-0 ml-md-auto outline-button">SEE ALL</a>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-lg-8 align-self-top text-center text-md-left text">
                        ...
                        <div class="row items text-left">
                            <div class="col-12 col-md-6 p-0">
                                <div class="row item">
                                    <div class="col-4 p-0 pr-3 align-self-center">
                                        <img src="modules/assets/images/team-1.jpg" alt="Person" class="person">
                                    </div>
                                    <div class="col-8 align-self-center text-left">
                                        ...
                                        <ul class="navbar-nav social share-list ml-auto">
                                            ...
                                            <li class="nav-item">
                                                <a href="home-1.html#" class="nav-link"><i class="fab fa-linkedin-in"></i></a>
                                            </li>
                                        </ul>
                                    </div>  
                                </div>
                                <div class="row item">
                                    <div class="col-4 p-0 pr-3 align-self-center">
                                        <img src="modules/assets/images/team-2.jpg" alt="Person" class="person">
                                    </div>
                                    <div class="col-8 align-self-center text-left">
                                        <h4>Emma Lopez</h4>
                                        <p>CHIEF MARKETING</p>
                            ...
                            <div class="col-12 col-md-6 p-0">
                                <div class="row item">
                                    <div class="col-4 p-0 pr-3 align-self-center">
                                        <img src="modules/assets/images/team-3.jpg" alt="Person" class="person">
                                    </div>
                                    <div class="col-8 align-self-center text-left">
                                        <h4>Oliver Jones</h4>
                                ...
                                <div class="row item">
                                    <div class="col-4 p-0 pr-3 align-self-center">
                                        <img src="modules/assets/images/team-4.jpg" alt="Person" class="person">
                                    </div>
                                    <div class="col-8 align-self-center text-left">
                                        <h4>T. Johnson</h4>
                                        <p>CEO & PRESIDENT</p>
            ...
            <div class="overflow-holder">
                <div class="container">
                    <div class="row intro">
                        ...
                        <div class="col-12 col-md-3 align-self-end">
                            <a href="home-1.html#" class="btn mx-auto mr-md-0 ml-md-auto primary-button">SEE ALL</a>
                        </div>
                    </div>
                    <div class="swiper-container mid-slider items" data-perview="3"> 
                        <div class="swiper-wrapper">
                            <div class="swiper-slide slide-center item">
                                <div class="row card p-0 text-center">
                                    <div class="image-over">
                                        <img src="modules/assets/images/news-1.jpg" alt="Lorem ipsum">
                                    </div>
                                    <div class="card-footer d-lg-flex align-items-center justify-content-center">
                                        <a href="home-1.html#" class="d-lg-flex align-items-center"><i class="icon-user"></i>Andrea Miller</a>
                                        <a href="home-1.html#" class="d-lg-flex align-items-center"><i class="icon-clock"></i>2 Days Ago</a>
                                    </div>
                            ...
                            <div class="swiper-slide slide-center item">
                                <div class="row card p-0 text-center">
                                    <div class="image-over">
                                        <img src="modules/assets/images/news-2.jpg" alt="Lorem ipsum">
                                    </div>
                                    <div class="card-footer d-lg-flex align-items-center justify-content-center">
                                        <a href="home-1.html#" class="d-lg-flex align-items-center"><i class="icon-user"></i>John Smith</a>
                                        <a href="home-1.html#" class="d-lg-flex align-items-center"><i class="icon-clock"></i>9 Days Ago</a>
                                    </div>
                                    <div class="card-caption col-12 p-0">
                                        <div class="card-body">
                                            <a href="page-single-post-1.html">
                            ...
                            <div class="swiper-slide slide-center item">
                                <div class="row card p-0 text-center">
                                    <div class="image-over">
                                        <img src="modules/assets/images/news-3.jpg" alt="Lorem ipsum">
                                    </div>
                                    <div class="card-footer d-lg-flex align-items-center justify-content-center">
                                        <a href="home-1.html#" class="d-lg-flex align-items-center"><i class="icon-user"></i>Andrea Miller</a>
                                        <a href="home-1.html#" class="d-lg-flex align-items-center"><i class="icon-clock"></i>16 Days Ago</a>
                                    </div>
                                    <div class="card-caption col-12 p-0">
                                        <div class="card-body">
                                            <a href="page-single-post-1.html">
                            ...
                            <div class="swiper-slide slide-center item">
                                <div class="row card p-0 text-center">
                                    <div class="image-over">
                                        <img src="modules/assets/images/news-4.jpg" alt="Lorem ipsum">
                                    </div>
                                    <div class="card-footer d-lg-flex align-items-center justify-content-center">
                                        <a href="home-1.html#" class="d-lg-flex align-items-center"><i class="icon-user"></i>John Smith</a>
                                        <a href="home-1.html#" class="d-lg-flex align-items-center"><i class="icon-clock"></i>23 Days Ago</a>
                                    </div>
                                    <div class="card-caption col-12 p-0">
                                        <div class="card-body">
                                            <a href="page-single-post-1.html">
                            ...
                            <div class="swiper-slide slide-center item">
                                <div class="row card p-0 text-center">
                                    <div class="image-over">
                                        <img src="modules/assets/images/news-5.jpg" alt="Lorem ipsum">
                                    </div>
                                    <div class="card-footer d-lg-flex align-items-center justify-content-center">
                                        <a href="home-1.html#" class="d-lg-flex align-items-center"><i class="icon-user"></i>David Cooper</a>
                                        <a href="home-1.html#" class="d-lg-flex align-items-center"><i class="icon-clock"></i>30 Days Ago</a>
                                    </div>
                                    <div class="card-caption col-12 p-0">
                                        <div class="card-body">
                                            <a href="page-single-post-1.html">
            ...
            <div class="container smaller">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <form action="https://nexgen-html.codings.dev/php/form.php" id="nexgen-subscribe" class="row m-auto items">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-8 pr-md-5 align-self-center text">
                        ...
                        <div class="row">
                            <div class="col-12 p-0">
                                <form action="https://nexgen-html.codings.dev/php/form.php" id="nexgen-simple-form" class="nexgen-simple-form">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="contacts">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a href="home-1.html#" class="mt-2 btn outline-button" data-toggle="modal" data-target="#map">VIEW MAP</a>
                                </li>
                            </ul>
                        </div>
                    </div>
