            ...
            <div class="container">
                <div class="row intro">
                    ...
                    <div class="col-12 col-md-3 align-self-end">
                        <a href="<?php echo base_url('service'); ?>contact" class="smooth-anchor btn mx-auto mr-md-0 ml-md-auto outline-button">GET IN TOUCH</a>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="contacts">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo base_url('service'); ?>" class="mt-2 btn outline-button" data-toggle="modal" data-target="#map">VIEW MAP</a>
                                </li>
                            </ul>
                        </div>
                    </div>
